...
def split_wide_boxes(boxes: list[tuple], bin_img: np.ndarray, factor: float = 1.3):
    """
...
def main():
    ...
    boxes = segment_by_profiles(bin_img, empty_thresh=3) 
    boxes = split_wide_boxes(boxes, bin_img, factor=1.3)
